...
This skill embodies the expertise needed to build Spandrel — a framework for structured knowledge management served via GraphQL and MCP. Load this when working on the Spandrel codebase.
